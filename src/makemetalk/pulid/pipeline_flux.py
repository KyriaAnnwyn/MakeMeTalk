...
class PuLIDPipeline(nn.Module):
    def __init__(self, dit, device, weight_dtype=torch.bfloat16, onnx_provider='gpu', *args, **kwargs):
        ...
        self.handler_ante = insightface.model_zoo.get_model('models/antelopev2/glintr100.onnx',
                                                            providers=providers)
        self.handler_ante_gender = insightface.model_zoo.get_model('models/antelopev2/genderage.onnx',
                                                            providers=providers)
        self.handler_ante.prepare(ctx_id=0)
        self.handler_ante_gender.prepare(ctx_id=0)
    ...
    def get_id_embedding(self, image, cal_uncond=False):
        ...
        if id_ante_embedding is None:
            ...
            gender = self.handler_ante_gender.get_feat(align_face)
        ...
        if not cal_uncond:
            return id_embedding, None, gender
        ...
        return id_embedding, uncond_id_embedding, gender
